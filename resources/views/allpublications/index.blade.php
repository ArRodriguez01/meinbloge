                    ...
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <x-dropdown>
                                ...
                                <x-slot name="content">
                                    <form method="POST" action="{{ route('destroyallpublications',$post)}}">
                                        @csrf
                                        @method('delete')
                                        <x-dropdown-link href="{{route('destroyallpublications',$post)}}" onclick="event.preventDefault();this.closest('form').submit();">
                                            {{ __('Borrar')}}
                                        </x-dropdown-link>
                                    </form>
                                </x-slot>
